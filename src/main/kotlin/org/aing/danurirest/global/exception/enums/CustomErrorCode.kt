...
enum class CustomErrorCode(
    ...
    NOT_SIGNED_UP(HttpStatus.NOT_FOUND, "이용 전 회원가입 폼 입력은 필수입니다."),
    FORM_ALREADY_SETUP(HttpStatus.NOT_FOUND, "이미 가입 폼 설정이 되어 있습니다. 해제 후 다시 설정 해주세요."),
    INVALID_JSON_SCHEMA(HttpStatus.BAD_REQUEST, "유효하지 않은 JSON 스키마 형식입니다."),
    FORM_ALREADY_CREATED(HttpStatus.CONFLICT, "이미 폼 입력이 완료 되어 있습니다."),
}
